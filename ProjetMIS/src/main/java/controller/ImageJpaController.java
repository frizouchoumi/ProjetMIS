...
public class ImageJpaController implements Serializable {
    ...
    public void edit(Image image) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            File idfileOld = persistentImage.getIdfile();
            File idfileNew = image.getIdfile();
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            File idfile = image.getIdfile();
            if (idfile != null) {
                idfile.getImageList().remove(image);
                idfile = em.merge(idfile);
            }
            Doctor iddoctor = image.getIddoctor();
            if (iddoctor != null) {
